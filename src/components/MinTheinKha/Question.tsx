...
import {questionData} from '../../features/bayDinSlice';

type Props = RootStackScreenProps<'MinTheinKhaQuestionScreen'>;
...
const Question = ({filteredQuestions}: QuestionProps) => {
  ...
  const handleToNumberListScreen = (
    ...
    return navigation.navigate('MinTheinKhaNumberListScreen');
  };
